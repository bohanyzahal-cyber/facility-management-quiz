...
RATE = "+0%"
ALBUM = "ניהול תשתיות גלובליות — פודקאסט תרגול"
...
def build(path, force=False):
    ...
    sh(["ffmpeg", "-v", "error", "-y", "-f", "concat", "-safe", "0",
        ...
        "-metadata", "artist=ניהול תשתיות גלובליות",
...
<title>פודקאסט — ניהול תשתיות גלובליות</title>
<style>
...
<div class="wrap">
<h1>פודקאסט — ניהול תשתיות גלובליות</h1>
...
<a href="../exam.html">📄 <span><b>חוברת החומר הפתוח</b> <em>· 43 עמודים להדפסה</em></span></a>
</div>
"""
